...
import { CoordinatesType, DefaultMenuPropsType, ILabelElement, IGlobalEvent } from 'store/modules/App/types';

export type WrapperOfMenuOfLabelPartPropsType = { id: string; onClose: () => void } & CoordinatesType &
...
export type MenuStateOfMenuOfChangingGlobalEventItemType = {} & IGlobalEvent & CoordinatesType;
